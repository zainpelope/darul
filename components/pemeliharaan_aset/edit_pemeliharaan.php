...
$sql = "SELECT * FROM perbaikan_aset WHERE id_perbaikan = $id";
        ...
        <div class="main-panel">
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <h2>Edit Perbaikan Aset</h2>
                    <form action="proses_edit_pemeliharaan.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="id_aset" name="id_aset" class="form-select" required>
                                <?php while ($row_aset = $result_aset->fetch_assoc()) { ?>
                                    <option value="<?php echo $row_aset['id_aset']; ?>" <?php if ($row['id_aset'] == $row_aset['id_aset']) echo 'selected'; ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="status" name="status" class="form-control" value="<?php echo htmlspecialchars($row['status']); ?>" required>
                        </div>
                        <button type="submit" class="btn btn-primary">Simpan</button>

                        <a href="../../index.php?page=pemeliharaan_aset" class="btn btn-secondary">Kembali</a>
                    </form>
                </div>
            </div>
