...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bind_param('sss', $deskripsi_kebutuhan, $tanggal_dibuat, $status);
        ...
        <div class="main-panel">
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <h2>Tambah Kebutuhan Aset</h2>
                    <form method="POST" action="">
                        <div class="mb-3">
                            <label for="deskripsi_kebutuhan" class="form-label">Deskripsi Kebutuhan</label>
                            <textarea class="form-control" id="deskripsi_kebutuhan" name="deskripsi_kebutuhan" rows="3" required></textarea>
                        </div>
                        <div class="mb-3">
