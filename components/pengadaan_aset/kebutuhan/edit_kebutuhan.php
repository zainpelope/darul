...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE kebutuhan_aset SET deskripsi_kebutuhan=?, tanggal_dibuat=?, status=? WHERE id_kebutuhan=?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('sssi', $deskripsi_kebutuhan, $tanggal_dibuat, $status, $id);
    ...
    $sql = "SELECT deskripsi_kebutuhan, tanggal_dibuat, status FROM kebutuhan_aset WHERE id_kebutuhan=?";
    $stmt = $conn->prepare($sql);
                ...
                <div class="page-inner">
                    <div class="page-header">
                        ...
                        <ul class="breadcrumbs mb-3">
                            ...
                            <li class="nav-item">
                                <a href="#">Tambah Kebutuhan Aset</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <h2>Edit Kebutuhan Aset</h2>
                    <form method="POST" action="">
                        <div class="mb-3">
                            <label for="deskripsi_kebutuhan" class="form-label">Deskripsi Kebutuhan</label>
                            <textarea class="form-control" id="deskripsi_kebutuhan" name="deskripsi_kebutuhan" rows="3" required><?php echo htmlspecialchars($data['deskripsi_kebutuhan']); ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="tanggal_dibuat" class="form-label">Tanggal Dibuat</label>
                            <input type="date" class="form-control" id="tanggal_dibuat" name="tanggal_dibuat" value="<?php echo htmlspecialchars($data['tanggal_dibuat']); ?>" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <a href=" ../../../components/pengadaan_aset/kebutuhan/kebutuhan_aset.php" class="btn btn-secondary">Kembali</a>
                    </form>
