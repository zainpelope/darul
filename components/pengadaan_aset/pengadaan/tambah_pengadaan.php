...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO pengadaan_aset (id_kebutuhan, tanggal_pengadaan, vendor, jumlah, status) 
            VALUES ('$id_kebutuhan', '$tanggal_pengadaan', '$vendor', '$jumlah', '$status')";
                        ...
                        <li class="nav-item active submenu">
                            ...
                            <div class="collapse show" id="base">
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="../../../components/pengadaan_aset/pengadaan/pengadaan_aset.phpavatars.html">
                                            <span class="sub-item">Kebutuhan Aset</span>
                                        </a>
                                    </li>
                                    <li class="active">
                                        <a href="../../../components/pengadaan_aset/pengadaan/pengadaan_aset.phppengadaan_aset.html">
                ...
                <div class="page-inner">
                    <div class="page-header">
                        ...
                        <ul class="breadcrumbs mb-3">
                            ...
                            <li class="nav-item">
                                <a href="#">Tambah Pengadaaan Aset</a>
                            </li>
                        </ul>
                    </div>

                    <h2>Tambah Pengadaan Aset</h2>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="id_kebutuhan" id="id_kebutuhan" class="form-control" required>
                                ...
                                while ($row_kebutuhan = $result_kebutuhan->fetch_assoc()) {
                                    echo "<option value='" . $row_kebutuhan['id_kebutuhan'] . "'>" . htmlspecialchars($row_kebutuhan['deskripsi_kebutuhan']) . "</option>";
                                }
                                ?>
                            </select>
                        </div>
