        ...
        <div class="main-panel">
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <h2>Edit Aset</h2>
                    <form action="pengadaan_aset.php?id=<?php echo $aset['id_aset']; ?>" method="post">
                        <div class="mb-3">
                        ...
                        <a href="../../../components/pengadaan_aset/pengadaan/pengadaan_aset.php" class="btn btn-danger mt-2 w-100">Batal</a>
                    </form>
