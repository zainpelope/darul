...
if (isset($_GET['id'])) {
    $id = intval($_GET['id']);
    $editResult = $conn->query("SELECT * FROM lokasi WHERE id_lokasi = $id");
...
if (isset($_POST['update'])) {
    ...
    $conn->query("UPDATE lokasi SET nama_lokasi = '$nama', deskripsi_lokasi = '$deskripsi' WHERE id_lokasi = $id");
    header("Location: ../../components/lokasi.php?page=lokasi_aset");
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="page-inner">
                    <div class="page-header">
                        ...
                        <ul class="breadcrumbs mb-3">
                            ...
                            <li class="nav-item">
                                <a href="#">Edit Lokasi Aset</a>
                            </li>

                        </ul>
                    </div>

                    <h2 class="mb-4">Edit Lokasi Aset</h2>

                    <form method="post">
                        <input type="hidden" name="id" value="<?php echo $editRow['id_lokasi']; ?>">
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama Lokasi</label>
                            <input type="text" class="form-control" id="nama" name="nama" value="<?php echo htmlspecialchars($editRow['nama_lokasi']); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="deskripsi" class="form-label">Deskripsi Lokasi</label>
                            <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" required><?php echo htmlspecialchars($editRow['deskripsi_lokasi']); ?></textarea>
                        </div>
                        <button type="submit" name="update" class="btn btn-primary">Update</button>
                        <a href="../../components/lokasi.php?page=lokasi_aset" class="btn btn-secondary">Kembali</a>
                    </form>
                </div>
            </div>
