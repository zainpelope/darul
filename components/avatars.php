      ...
      <div class="container">
        <div class="page-inner">
          ...
          <div class="container">
            ...
            <a href="pengadaan_aset/kebutuhan/add_kebutuhan.php" class="btn btn-success mb-3">Tambah Kebutuhan</a>
            <?php
            ...
            if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                ...
                echo '<td>
                    <a href="pengadaan_aset/kebutuhan/edit_kebutuhan.php?id=' . $row['id_kebutuhan'] . '" class="btn btn-primary">Edit</a>
                    <a href="pengadaan_aset/kebutuhan/hapus_kebutuhan.php?id=' . $row['id_kebutuhan'] . '" class="btn btn-danger" onclick="return confirm(\'Apakah Anda yakin ingin menghapus kebutuhan ini?\')">Hapus</a>
                </td>';
                echo '</tr>';
              }
