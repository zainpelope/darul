        ...
        <div class="main-panel">
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <h2 class="mb-4">Daftar Lokasi Aset</h2>

                    <a href="../components/lokasi/add_lokasi.php" class="btn btn-primary mb-3">Tambah Lokasi</a>
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . htmlspecialchars($row["deskripsi_lokasi"]) . "</td>";
                                    echo "<td>
                                         
                    <a href='../components/lokasi/edit_lokasi.php?id=" . $row["id_lokasi"] . "' class='btn btn-warning btn-sm'>Edit</a>
                   <a href='../components/lokasi/hapus_lokasi.php?delete=" . $row["id_lokasi"] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Yakin ingin menghapus?\")'>Hapus</a>
