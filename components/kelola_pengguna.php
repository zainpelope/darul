...
// Ambil data pengguna dengan join ke tabel hak_akses
$sql = "SELECT pengguna.id_pengguna, pengguna.nama_pengguna, pengguna.email, hak_akses.nama_role 
        FROM pengguna 
        JOIN hak_akses ON pengguna.id_role = hak_akses.id_role";
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="../components/tambah_pengguna.php" class="btn btn-primary">Tambah Pengguna Baru</a>
                    </div>
                                    ...
                                    <?php while ($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../components/edit_pengguna.php?id=<?= $row['id_pengguna'] ?>" class="btn btn-sm btn-warning">Edit</a>
                                                <a href="../components/delete_pengguna.php?id=<?= $row['id_pengguna'] ?>"
